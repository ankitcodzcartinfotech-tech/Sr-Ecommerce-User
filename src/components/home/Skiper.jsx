...
const Skiper = () => {
  ...
  return (
    <section className="w-full bg-white py-16">
      ...
      {/* Editorial Header */}
      <div className="mx-auto max-w-[1440px] px-4 sm:px-16 md:px-24 mb-12 text-center md:text-left">
      ...
      {/* Gallery Frame */}
      <div className="mx-auto max-w-[1440px] px-4 sm:px-16 md:px-24">
        <div
          ref={gallery}
    ...
    >
      {items.map((item, i) => (
        ...
        >
          ...
          <div className="absolute inset-x-2 bottom-2 md:inset-x-3 md:bottom-3 p-2.5 md:p-5 bg-black/50 backdrop-blur-md border border-white/10 rounded-xl md:transform md:translate-y-[120%] md:opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-[0.5s] ease-out z-20 flex flex-col justify-between shadow-2xl">
            <div>
              {item.subtitle && (
                <p className="text-[8px] md:text-[10px] font-bold uppercase tracking-widest text-emerald-400 mb-0.5">
                  {item.subtitle}
                </p>
              )}
              <h4 className="text-[10px] md:text-sm font-medium text-white line-clamp-1 mb-0.5">
                {item.title}
              </h4>
              <p className="text-[10px] md:text-xs font-semibold text-white/95">
                {item.price}
              </p>
            </div>
            
            <div className="hidden md:flex mt-3 items-center justify-between text-[10px] md:text-[11px] font-bold text-white group-hover/btn:text-emerald-300 transition-colors border-t border-white/10 pt-3">
              <span>SHOP NOW</span>
